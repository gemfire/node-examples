...
function launchServer() {
    ...
    gfsh -e "connect --locator=localhost[10337]" -e "start server --locators=localhost[10337] --bind-address=127.0.0.1 --server-port=40404 --name=server --dir=${APP_HOME}/data/server"
